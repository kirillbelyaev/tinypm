...
import static edu.csu.lpm.implementation.png.Parser_implement.caprec;
    ...
    public static Integer command_CHANGE_PASSWORD(String e)
    {
        try 
        {
            ...
            if(!old_password.equals(actualPassword)) {
                Parser_implement.set_ERROR_MESSAGE("Invalid Detail. Unable to perform command");
        ...
        {
            Logger.getLogger(ParserExecute.class.getName()).log(Level.SEVERE, null, ex);
            return INDICATE_CONDITIONAL_EXIT_STATUS;
        } 
